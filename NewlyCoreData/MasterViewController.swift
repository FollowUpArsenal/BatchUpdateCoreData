...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    @IBAction func toggle(sender: AnyObject) {
        ...
        for objectId in objectIds {
            var objId = objectId as NSManagedObjectID
            var err : NSError? = nil
            var obj = localManagedObjectContext.existingObjectWithID(objId, error: &err)!as NSManagedObject
            
            if obj.fault == false && err == nil{
                localManagedObjectContext.refreshObject(obj, mergeChanges: true)
            }
        }
